...
class SceneDescription(BaseModel):
    ...
    content_elements: list[PageElement] = Field(
        description="Key content elements (headings, paragraphs, images)"
    )
    ...
    @field_validator("notable_colors", mode="before")
    @classmethod
    def _coerce_notable_colors(cls, v: Any) -> str:
        """Accept list or string from Gemini and normalize to string."""
